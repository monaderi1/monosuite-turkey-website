(() => {
  ...
  const nav = isTr ? [
    ['platform','Platform'],['asset','Varlık İstihbaratı'],['security','Güvenlik ve Maruziyet'],['risk','Risk'],['integrations','Entegrasyonlar'],['deployment','Dağıtım'],['editions','Sürümler']
  ] : [
    ['platform','Platform'],['asset','Asset Intelligence'],['security','Security & Exposure'],['risk','Risk'],['integrations','Integrations'],['deployment','Deployment'],['editions','Editions']
  ];
  const idx = isTr ? 1 : 0;
